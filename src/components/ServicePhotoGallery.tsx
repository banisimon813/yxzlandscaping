  ...
  return (
    <section className="bg-secondary py-20">
      <div className="container">
        ...
        <p className="mt-3 text-center text-muted-foreground">Recent projects in Woodbridge, Vaughan and across the GTA</p>
            ...
            <figure key={photo.id} className="overflow-hidden rounded-lg border border-border bg-card">
              <img
                ...
                alt={
                  photo.alt_text ||
                  photo.caption ||
                  `${serviceName} project by YXZ Landscaping & Hardscaping in Woodbridge, Vaughan`
                }
